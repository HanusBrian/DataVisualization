export const HelptextData = [{
	...
	assessment: "As you are completing other sections of the audit also observe employee interactions with guests. The key is to constantly have an ear out for superstar service as you are doing other sections of the audit.  \n\nEmployees should be smiling and speaking to or acknowledging each guest at every opportunity. Look for employees who are being robotic or insincere.  They must say \"Please\", \"Thank You\" or other pleasantry with each guest, as well as \"Good Bye\" or Farewell\" to each guest; and, provide an invitation to return. \n\nNote: FL (front line) employees should not be cited here as they have their own question for this below.",
	criticality: "2",
    color: "#EEAF00",
...
},
{
	...
	threshold: "Cite an opportunity if one or more occurrence is observed.",
	assessment: "As you are completing other sections of the audit also observe how employees speak with guests. The key is to constantly have an ear out for superstar service as you are completing other sections of the audit.  Employees should maintain good posture and not lean on the counter or register.\n\nWhile conversing with guests, employees should speak clearly with a friendly voice and make eye contact while maintaining good posture.\nAlso assess that an appropriate number of registers are open for the sales volume being experienced. You willl need to ask to manager to show you the ROS board and check the time of day to determine how many are working which determines how many registers should be open at that time. (See JOB AID: OA ECOSURE SUPPORT DOC (ROS and GIFT CARDS)",
	criticality: "2",
    color: "#EEAF00",
...
},
{
	...
	threshold: "Cite an opportunity if one or more occurrence is observed.",
	assessment: "As you are completing other sections of the audit also observe how Front Line (FL) Cashiers follow the order taking process. They should give a friendly greeting with a featured product. FL Cashier should ask if they want it medium or large. Add ons are no always required but could include examples such as \"Would you like two apple turnovers for a dollar? Would you like to try our frozen lemonade? Would you like to add a dessert to that order?\"\n\nEnsure that the front line cashier follows the correct order taking process:  Friendly greeting with featured product, ask if want a combo, ask if want to upsize, suggest an add-on (if appropriate), order confirmation, Please/Thank you.\n\nAll these steps must be performed for this standard to be marked in compliance.  ",
	criticality: "2",
    color: "#EEAF00",
...
},
{
	...
	threshold: "Cite an opportunity if one or more occurrence is observed.",
	assessment: "Try to oberve a dining room delivery and observe that the follow table scripting is followed:  Friendly greeting, Deliver food, Verify order accuracy, Provide correct condiments, include offering the guest a Comment Card (Carls Jr: Comment card must be offered as food is delivered. Hardees: The employee will point out comment cards that should already be available on the table set.) and with an invitation to provide feedback on the comment car or by using the guest survey on the back of the receipt if the customer does not want to use the comment card.  Lastly provide a Thank You. \n\nNote: Dine in orders must be delivered to table if the customer has completed the order and has sat down at a table. Do not cite if a guest chooses to stand and wait their order at the counter area.",
	criticality: "2",
    color: "#EEAF00",
...
},
{
	...
	threshold: "Cite an opportunity if one or more occurrence is observed.",
	assessment: "Whenever an employee is within close proximity to a guest, the employee should identify opportunities to assist the customer and provide it. \nExample: If the employee is cleaning a table and a guest with a child is sitting down at a close table, the employee should offer to get a booster seat or high chair.\n\nAny time a customer is within 5 - 6 feet (may be farther if low volume time of day) of an employee, the employee should be identifying and offering assistance.",
	criticality: "2",
    color: "#EEAF00",
...
},
{
	...
	assessment: "While conducting other aspects of the audit, observe at least 3 drive thru (DT) interactions. If just one guest is not greeted within five seconds or put on hold, you will cite an occurence, regardless of how many \"good\" interactions you\'ve observed.\n\nThe guest should be greeted within 5 seconds of pulling up to the order confirmation board. A guest should never be placed on hold or asked to wait to place their order.",
	criticality: "1",
    color: "#007AC9",
...
},
{
	...
	threshold: "Cite an opportunity if one or more occurrence is observed.",
	assessment: "Observe 3 - 5 drive thru customer interactions to ensure the process is followed:\n\nEnsure that the drive thru cashier follows the correct order taking process:  Friendly greeting (smile in voice) with featured product, ask if want a combo, ask if want to upsize, suggest an add-on (if appropriate), order confirmation, Please/Thank you.\n\nAll these steps must be performed for this standard to be marked in compliance.  ",
	criticality: "2",
    color: "#EEAF00",
...
},
{
	...
	threshold: "Cite an opportunity if one or more occurrence is observed.",
	assessment: "Observe 3 - 5 drive thru customer interactions to ensure the process is followed:\n\nObserve that the proper closing procedures are used at the drive thru window as follows: order is delivered courteosly to guest with receipt and napkins placed neatly in the bag and, apporpriate Thank You given\n",
	criticality: "2",
    color: "#EEAF00",
...
},
{
	...
	threshold: "Cite an opportunity if one or more occurrence is observed.",
	assessment: "If observed, ensure that cars that are asked to pull forward are only asked to do this when the next car\'s order is ready and waiting. The employee should follow the steps on the pull car forward job aid.\n\nAdditionally, follow the runner when they take the order out to the guest to ensure that they politely say  \"Here is your order; thanks for waiting\".",
	criticality: "2",
    color: "#EEAF00",
...
},
{
	...
	threshold: "Cite an opportunity if one or more occurrence is observed.",
	assessment: "If a customer places their order inside and asks for it \"To Go\", ensure that the proper handling of a To Go order delivery is followed:  Verify order, offer anything else, deliver order courteously with napkins and straws (if applicable) and appropriate thank you.\n",
	criticality: "2",
    color: "#EEAF00",
...
},
{
	...
	threshold: "Cite an opportunity if one or more occurrence is observed.",
	assessment: "If observed, assess that guest complaints are handled immediately in a positive and professional manner; and, resolved to the guest\'s satisfaction.  \n\nThe following should be exhibited in the customer complain resolution:  Listen & Empathize, Apologize (without admitting guilt or liability), find out how the guest wants the issue resolved, take immediate action, thank the guest.  ",
	criticality: "2",
    color: "#EEAF00",
...
},
{
	...
	threshold: "Cite an opportunity if one or more occurrence is observed.",
	assessment: "Ensure that the location has gift cards available and that the cashier is knowledgeable on handling gift cards.  \n\nAsk the Cashier (at front counter or drive thru), \"Please tell me what you would do if a guest requested a gift card and how you would activate it?\"\n\nNote: The employee does not actually have to process a gift card. They just need to display the correct screen in the POS and show what tab they would select and then the button they would hit. \n",
	criticality: "1",
    color: "#007AC9",
...
},
{
	...
	threshold: "Cite an opportunity if one or more occurrence is observed.",
	assessment: "All employees wearing approved, clean safety shoes, w/slip resistant soles.  Observe the employees\' shoes. If an employee\'s shoes appear to not be safety shoes, or have worn tread, verify the shoes meet standards by asking to see the sole.\n\nDark colored socks must be worn. Observe for socks as completing assessment. Do not ask employees to show their socks if they are not visible.",
	criticality: "1",
    color: "#007AC9",
...
},
{
	...
	threshold: "Cite an opportunity if one or more occurrence is observed.",
	assessment: "Assess facial hair on male employees for the following:  moustache not to exceed the corners of the mouth; side burns neatly trimmed; big sideburn chops are ok as long as permitted by local jurisdiction.\n\nNote:  HFS (Hardee\'s) goatees are permitted if neatly trimmed. ",
	criticality: "1",
    color: "#007AC9",
...
},
{
	...
	threshold: "Cite an opportunity if one or more occurrence is observed.",
	assessment: "Observe employees and cite for any employees acting in an unprofessional manner. Additionally, employees cannot carry or use their cell phones while working. Cit for any employee observed carrying or using a cell phone while working. \n\nNote: Do not cite for managers making work related calls.\n",
	criticality: "1",
    color: "#007AC9",
...
},
{
	...
	assessment: "The Centerpost is in front of the heated transfer bin. Observe 3 - 5 orders being assembled at the Centerpost for accuracy based on printed tickets or order screen.\n",
	criticality: "2",
    color: "#EEAF00",
...
},
{
	...
	assessment: "While assessing the product build, packaging, etc. observe how special orders are marked. Ensure that special orders/customer alterations (if observed) are properly marked using the correct grill receipts or appropriate backline sticker labels to ensure customer order accuracy.  For product that is packaged in boxes, punch holes are used accordingly. Special orders can include removing or adding toppings from a sandwich.\n\nIf you hear an employee ask another employee what is in the packaging, observe what is happening. This could be an  indication the packaging was not marked correctly for a special order.\n\nNote: HFS (Hardee\'s) uses the backline labels.  They both use stickers to identify what is custom.  Punch holes indicate what product is in the box (bacon swiss instead of big chicken).  If you do not see a special order mark as \"N/A\".",
	criticality: "2",
    color: "#EEAF00",
...
},
{
	...
	assessment: "Observe a minimum of 3 orders and  a maximum of 5 orders. Do not ask to look into a bag after the order has been placed in the bag. Observed number of napkins through observation. Look for employees grabbing handfuls of napkins for an order with no system of counting the correct number.  \n\nOverstuffed bags are assessed as follows: \n4# bag gets the max of 1 wrapped sandwich and 1 side order\n8# bag gets a max of 3 wrapped sandwiches and 2 side orders, \n12# bag gets a maxiumum of 4 wrapped sandwiches and 3 side items or only 2 sandwiches in clamshell boxes. \n\nThe top of all bags should be folded over before handing to guests. \n\nNote: Do not cite for a restaurant pulling from a stack of napkins instead of a dispenser that dispenses one napkin at a time unless they are blatantly putting in incorrect number of napkins.",
	criticality: "1",
    color: "#007AC9",
...
},
{
	...
	assessment: "The drive thru area should be set-up in zones following the most current DTOS. Refer to job aids and operations manual to ensure sysem is followed correctly. These drive thru zones should be used according to proper procedure with each zone used for its intended purpose in expediting the guest order.\n\nReceipts should be kept in the designated zone. Coach if you observe receipts attached to bags with a stapler instead of tape. Drinks, napkins and condiments should also be placed in zones. As order is filled, the bag is placed in a specific zone.",
	criticality: "1",
    color: "#007AC9",
...
},
{
    ...
    threshold: "N/A",
	assessment: "Observe a total of 20 service times. If the restaurant has a Drive-Thru, 10 of the times should be Drive-Thru times (DT). If there is no Drive-Thru, use the DT spaces for Dine/To-Go orders.  If you cannot get 20 service times, check the N/A boxes for service times not completed. Record all the service times observed (even if within 3:30)\nService times start after the guest completes their order (menu board/front counter) and ends when the guest receives the order. If the drive thru Service times start when the order taker asks the driver to pull forward and ends when they receive their order.\n\nUse the Comments section to explain why service times exceeded standard.  The standard time expectation is 3:30 or less for all times of day.",
	criticality: "0-3",
    color: "#FF0000",
...
},
{
	...
	threshold: "Cite an opportunity if one or more occurrence is observed.",
	assessment: "HFS: Hardee\'s cinammon raisin biscuits will be held on a tray for a maximum of 30 minutes. They must have a red timing number on them and can\'t be expired. There is no leeway on expiration times, if it expires at 10:15am then it’s a violation at 10:16am. \n\nNote: A few Hardee\'s franchise locations will do cinnamon raisin biscuits from scratch and hold them unglazed on the overshelf. They also get 30 minutes max and must have a timing number that follows them from overshelf to the transfer bin. ",
	criticality: "1",
    color: "#007AC9",
...
},
{
	...
	threshold: "Cite an opportunity if one or more occurrence is observed.",
	assessment: "All other finished breakfast products get 15 minutes hold times here except at CJR the Brkfst burritos get 5 minutes.\n\nNote: CJR Breakfast Burger & Sourdough Brkst and HFS Breakfast Burger and Frisco Brkf sandwich are cooked to order only and may not receive hold times!",
	criticality: "1",
    color: "#007AC9",
...
},
{
	...
	threshold: "Cite an opportunity if one or more occurrence is observed.",
	assessment: "Observe biscuits being made at the biscuit station.  Bag of premix is poured into the mixing bowl and \"fluffed\" to incorporate air back into the mix. Large pieces of shortening must be broken up to pea size. Two quarts of buttermilk is added and they biscuit maker MUST use their hand to get all the buttermilk out of the pitcher.\nDough is mixed by hand keeping fingers stiff, apart, and extended. Mixing stops when there are not dry or wet spots left. They must not overmix. \nIf a full batch is made, the dough is cut in quarters in the bowl (for a half batch the dough is cut in half). \n\nFlour is applied in two circles on the table (One smaller for pressing and one larger for rolling) The dough is formed into a loaf in the smaller of the circles. When they form the loaf on the table they should apply downward pressure twice with their hands(once horizontally and once vertically). The loaf should not be stretched!\n\nAfter pressing down the loaf is folded with the sides folded in first and then two folds of the loaf after the sides are folded in. The process is then repeated back to the pressing down step and folding again.  \n\nOnce the loaf is formed it is moved to the other circle of flour and rolled. The folded loaf should be rolled out  horizontally and vertically, not just one direction. Check that they use the biscuit cutter to check the height of the rolled loaf all the way around. They should roll it out more if it is too tall.\n\nFinally the biscuit cutter should be used to cut out the biscuits. The cut outs should be as close as possible without overlapping to maximize the number of biscuits per rolled loaf of dough. They should be cut out in a honeycomb pattern (see Job Aid). Cutter should be floured as needed to prevent sticking. Biscuits should be properly panned on a pan sprayed with pan spray in a number depending on sales level (See Job Aid). Leftover trim dough must be timed for 30 minutes with a timing number and cut biscuits not put in oven must be timed for 1 hour max.",
	criticality: "2",
    color: "#EEAF00",
...
},
{
	...
	threshold: "Cite an opportunity if one or more occurrence is observed.",
	assessment: "Biscuits must be baked on the 1-3-5 (top-center-bottom) rack positions and always use the highest rack available. If only 1 tray of biscuits was being baked it would be placed on the top 1 rack. \n\nObserve biscuits are being checked for doneness: Biscuit maker should check the tallest biscuit and peel it in half to check if it is done at the center and that there is a burst of steam. If it is still wet, the tray should be placed back in the oven for 1 minute. No ned to check another biscuit after 1 more minute in the oven.\n\nBasting Biscuits: Associate should baste biscuits with liquid margarine using the 3’’ pastry brush. Baste 3 biscuits at a time using the 1-2-3, 3-2-1 brushing method. Biscuits should not appear greasy after basting.",
	criticality: "2",
    color: "#EEAF00",
...
},
{
	...
	threshold: "Cite an opportunity if one or more occurrence is observed.",
	assessment: "Check for a grease pen hold time or sticker. They can use either method as long as they follow it.  Check water temperature is in acceptable range. \n\nCJR: red dot spoon or 2 oz spoon must be present to portion gravy onto the burrito. HFS: 5 oz ladle used for gravy. 1 oz of hot water per 2 inches o f gravy. \n\nHot water must  come from a hot water dispenser, not just a sink. No need to temp the hot water if they used the Bunn hot water dispenser. \n\nCJR Company stores will use a specific pitcher with lid must be used to transport hot water. This is a new item that will not be at all locations yet. \n\nNote: All locations must at minimum use a container with a handle to transport the hot water.",
	criticality: "1",
    color: "#007AC9",
...
},
{
	...
	threshold: "Cite an opportunity if one or more occurrence is observed.",
	assessment: "If the carton of liquid eggs is open they need to dump the entire container into the 1/6 pan and the pan needs to be in an ice bath or a refrigerated roll top. \n\nHFS: They hold the liquid egg in a Chill-It pan or a roll pack. Bulk liquid egg comes in a large Volpak bag of liquid eggs used that is held in a reach in cooler. That bag of liquid eggs is dispensed into the Chill-It pan. The nozzle of the Volpak bag must removed for cleaning and sanitizing between bags and at least once daily.  Hardee\'s: Only 6 ladles of eggs should be cooked at a time.",
	criticality: "1",
    color: "#007AC9",
...
},
{
	...
	threshold: "Cite an opportunity if one or more occurrence is observed.",
	assessment: "Omelet Blend: made to recipe, correct scoop used to portion product stored in the product. CJR: red dot spoon or 2 oz scoop;  HFS: #20 food disher used for Omelet Blend (look for a #20 on the handle). \n\nHFS: No more than 4 omelettes cooked at once. \n\nCJR: Fresh salsa, no excess liquid,  false bottom insert must present, perforated 1 oz salsa spoon must be used (1 oz is stamped on the handle). 48 hour hold time must be monitored. Shredded cheese check good quality (not wet or mushy). 10 inch clear or black plastic spoon must be used and hold time is 24 hr. ",
	criticality: "1",
    color: "#007AC9",
...
},
{
	...
	threshold: "Cite an opportunity if one or more occurrence is observed.",
	assessment: "The raw sausage patties must be stored frozen. \n\nCJR: The dedicated tongs used are square tip tongs and will be sitting in a pan. Gloved hands may also be used for Raw sausage patties as long as gloves are removed and hands washed after. Sausage patties are held in a 1/3 size pan with a metal drain insert. \n\nFinished sauage cooked to 160 F. 60 minute hold time observed. Cooked sausage uses a dedicated transfer tray (sausage patties use orange transfer tray).",
	criticality: "1",
    color: "#007AC9",
...
},
{
	...
	threshold: "Cite an opportunity if one or more occurrence is observed.",
	assessment: "Eggs are scrambled, not chopped. Eggs should not sit on the grill and chopped, should be scrambled immediately after they are ladled on. Scrambled eggs should be removed from the grill immediately after cooking and be light and fluffy in appearance. \n\nIF HELD: Pan with a solid lid in approved hot holding equipment (steamer/heat well or Prince Castle. Purple dot scoop used to scrambled eggs or 1.5 oz scoop for franchise locations. Hardee\'s: #16 food disher (#16 will be stamped on it).",
	criticality: "1",
    color: "#007AC9",
...
},
{
	...
	threshold: "Cite an opportunity if one or more occurrence is observed.",
	assessment: "Prior to assessing this question, determine if the location being assessed is a regular kitchen or a pilot kitchen efficiency location. \n\nCheck the produce storage pans to ensure the pans are not overfilled to the point where the product is being crushed.\n\nProduce must be left out at room temperature prior to using so it doesn\'t bring down the temperature of the burger/sandwich.",
	criticality: "1",
    color: "#007AC9",
...
},
{
	...
	threshold: "Cite an opportunity if one or more occurrence is observed.",
	assessment: "Ensure the correct number of patties is on a tray, covered and tagged (day dot/food label) as follows:\n\nMaximum of 6 half pound beefsteaks\nMaximum of 9 third pound beefsteaks per tray. \nMaximum 8 turkey patties per tray\nMaximum of 6-8 chicken breasts per tray\nMaximum of 12 cod fillets per tray \n\n(Reference CP CHART - THAWING CHICKEN_BEEF_FISH_TURKEY CHART)\n\n",
	criticality: "1",
    color: "#007AC9",
...
},
{
	...
	threshold: "Cite an opportunity if one or more occurrence is observed.",
	assessment: "Check that all meat is placed on the broiler properly: employees should feed beef patties chicken patties (with BBQ sauce side facing up) and cod fillets at the end of the belt. \n\nEmployees should feed angus beefsteak patties, turkey patties, and 8/1 beef patties under the heat shield.  Do not cite for patties placed half under heat shield as long as there is an attempt to place under the heat shield based on belt traffic. No meats should be fed closer than 2 inches from side edge of belt and 1 inch should be left between meat patties. (See Job Aid 69948 - CP CHART - FEEDER CHART)\n\nNote: If you observed bad quality burgers on the make table side it may be an indication that they are being fed improperly on the belt.",
	criticality: "1",
    color: "#007AC9",
...
},
{
	...
	threshold: "Cite an opportunity if one or more occurrence is observed.",
	assessment: "HFS: At Hardee\'s observe the meat being removed from the charbroiler to ensure it meets standards. Or, if staged on a sizzler plate, it meets the Sizzler plate standards.\n\nCJR: At Carl\'s Jr obseve the meat coming off the broiler and in the holding bins of the Prince Castle to ensure it meets standards.\n\nMeat is juicy with a moist glossy appearance, no charred edges, patty edge completely cooked.",
	criticality: "2",
    color: "#EEAF00",
...
},
{
	...
	threshold: "Cite an opportunity if one or more occurrence is observed.",
	assessment: "HFSL At Hardee\'s observe the meat being removed from the charbroiler to ensure it meets standards. Or, if staged on a sizzler plate, it meets the Sizzler plate standards.\n\nChar Chicken breasts are only allowed to be staged on the sizzler plate if sales planner calls for it. If you observe Char Chicken on the sizzler plate, ask to manager to see the sales plan.  If Char Chicken is listed as \"level 3\" on the production plan, it is allowed to be staged on the sizzler plate.  Turkey is not sold at these locations.\n\nCJR: At Carl\'s Jr obseve the meat coming off the broiler and in the holding bins of the Prince Castle to ensure it meets standards.\n\nNote: For all locations, to meet standards the meats should be juicy with a moist glossy appearance, no charred edges, patty edge completely cooked.\n",
	criticality: "1",
    color: "#007AC9",
...
},
{
	...
	threshold: "Cite an opportunity if one or more occurrence is observed.",
	assessment: "Buns, sourdough bread, LTO bread products will have a printed \"use by\" date on a tag or on the bag. Confirm the date on the bag has not passed. \n\nFrozen buns coming from the distribution center will have a day dot or food label . Confirm the date has not passed.\n\nFrozen buns are thawed at room temperature on a bun tray. There will be a day dot or food label on the tray. Confirm the date has not passed.\n\nAll buns shoulld be toasted prior to use. The cut side of the bun should be evenly toasted with no charring or burned edges. ",
	criticality: "1",
    color: "#007AC9",
...
},
{
	...
	threshold: "Cite an opportunity if one or more occurrence is observed.",
	assessment: "Roast beef should be cooked at 200 F in Convection Ovens (pre-heat 30 min) for 1 hour and 45 minutes, 250 F in Barbecue King Oven (pre-heat 30 min) for 2 hours, and 300 F in Alto-Shaam Oven (pre-heat 60 min) for 1 hour 45 minutes.  Associate should insert a clean and sanitized dial stem thermometer in each roast to ensure it is cooked to a temperature of 145 F for 3 minutes and continue cooking in 3 minute internvals until it does.\n\nRoasts should be removed from oven and placed in warming oven/cabinet to stabilize prior to slicing. Holding time is 24 hours in the oven. Holding time on the slicer is 15 minutes and must be monitored with a timing number or other approved system. ",
	criticality: "1",
    color: "#007AC9",
...
},
{
	...
	threshold: "Cite an opportunity if one or more occurrence is observed.",
	assessment: "Confirm products that have been set out to be brought up to room temperature prior to use are tagged and not used before tempering for at least 1 hour of their 2 hour tempering time (See Job Aid: 71287 - Tempering Chart)\n\n",
	criticality: "1",
    color: "#007AC9",
...
},
{
	...
	threshold: "Cite an opportunity if one or more occurrence is observed.",
	assessment: "Check items that weren\'t covered in other questions (such as produce) to confirm the prepped ingredients are prepped and covered per standards.\n",
	criticality: "1",
    color: "#007AC9",
...
},
{
	...
	threshold: "Cite an opportunity if one or more occurrence is observed.",
	assessment: "Check the heat well/steamers to ensure the products are not dried out or crusted over.\n\nCheck the hot holding temperature for product other than chili, mushroom sauce, and hot dogs (items assessed in hot holding for food safety) to be 140F or above.",
	criticality: "1",
    color: "#007AC9",
...
},
{
	...
	threshold: "Cite an opportunity if one or more occurrence is observed.",
	assessment: "Check that burgers/sandwiches requiring a collar wrap have them. \nCheck that the collar wrap is not placed well above or well below the half way point of the burger/sandwich to allow for maximum visual presentation.",
	criticality: "1",
    color: "#007AC9",
...
},
{
	...
	threshold: "Cite an opportunity if one or more occurrence is observed.",
	assessment: "Observe 3 different products being assembled and assess all items are executed properly for these 3 questions in a row referring to build charts. \n\nFor Build Charts only assess that the charts are present, not that they are current (1 for burgers, 1 for sandwiches, 1 for breakfast items must be present. They may be combined into one large laminate). Sauces should be spread coast-to-coast, not just a dab in the middle. Sauces should be evenly distrubuted on the toasted bun. Some sauces will be added in a spiral and others in a z pattern (check build charts).",
	criticality: "1",
    color: "#007AC9",
...
},
{
	...
	threshold: "Cite an opportunity if one or more occurrence is observed.",
	assessment: "Observe 3 different products being assembled and assess all items are executed properly for these 3 questions in a row. \n\nFor Build Charts only assess that the charts are present, not that they are current (1 for burgers, 1 for sandwiches, 1 for breakfast items must be present. They may be combined into one large laminate). Sauces should be spread coast-to-coast, not just a dab in the middle. Sauces should be evenly distrubuted on the toasted bun.",
	criticality: "1",
    color: "#007AC9",
...
},
{
	...
	threshold: "Cite an opportunity if one or more occurrence is observed.",
	assessment: "Use the test tube to check the color of the oil. Cite an opportunity if the test tube or the chart are missing (chart does not have to posted, just needs to be available). \n\nCheck the embossed fill level line in the fryer to determine fill level is appropriate. Look for excessive particles present in fryer (fryers should be skimmed between rushes). Employees should only add fresh shortening to fryer 1. When transferring shortening from fryer 1 to 2 or 3 they should use an approved pan with handle for transferring hot oil.",
	criticality: "1",
    color: "#007AC9",
...
},
{
	...
	threshold: "Cite an opportunity if one or more occurrence is observed.",
	assessment: "During low volume periods between rushes assess that fried products are only cooked to order. To verify the sales volume at that time, ask the GM what sales level they are in. Sales levels run between 1-3 with 1 being the lowest and 3 being peak. If they state are level 1 all fried product should be cooked to order. If they state they are level 2 all fried product should be cooked to order unless the manager can show you on their sales planner that they can have fried product in the fry dump holding at that time of day. During level 3 product may always be held in the fry dump.\n\nRed timing numbers will typically be in place at fry dump station to monitor hold times (electronic, time numbers, or laminate are all approved methods). If it is not evidend how they are timing it ask them what they are using for their timing system.",
	criticality: "1",
    color: "#007AC9",
...
},
{
	...
	threshold: "Cite an opportunity if one or more occurrence is observed.",
	assessment: "As employees are handling the frozen bags of fries, check that they are not throwing or dropping the bags around. They should be handled gently to prevent breakage.\n\nCheck for a timing number for pre-staged fries. They get 30 minutes at ambient temperature. This will typiaclly be during pre-rush times. Very few stores will have a fry dispenser but if present, check that it does not dispense more than 1/2 a basket. If the fry dispenser is present check that lids is in place and  that exterior and chute area of  it is clean (no excessive ice) and working properly. ",
	criticality: "1",
    color: "#007AC9",
...
},
{
	...
	threshold: "Cite an opportunity if one or more occurrence is observed.",
	assessment: "French Fries should be cooked for 2:30 and held for a maximum of  7 minutes. Check that baskets are not pulled early, that baskets are drained for a minimum of 10 seconds before dumping, and that product is crisp, not soggy. Salt French Fries get 5 shakes per 1/2 basket and 2 shakes per 1/4 basket.\n\nNote: Also mark in this question if you observe any unapproved products put into the fryers!",
	criticality: "1",
    color: "#007AC9",
...
},
{
	...
	threshold: "Cite an opportunity if one or more occurrence is observed.",
	assessment: "Fried Zucchini should be cooked for 3:00 and helf for a maximum of 10 minutes. Carefully check that this product is not soggy because it is not a popular product and gets held too long.\nFried Zucchini is only found at CJR. Please N/A this question at HFS.",
	criticality: "1",
    color: "#007AC9",
...
},
{
	...
	threshold: "Cite an opportunity if one or more occurrence is observed.",
	assessment: "Fried chicken is only found at Hardee\'s. It is cooked for 4:45 and held for a maximum of 30 minutes.\n\nThe side item to check here is the apple turnover. Apple turnover should be cooked for 7:00 and can be held for a maximum of 3 hrs.\n\nN/A this question for CJR. ",
	criticality: "1",
    color: "#007AC9",
...
},
{
	...
	threshold: "Cite an opportunity if one or more occurrence is observed.",
	assessment: "A timing system must be in place for the breading and washing the tongs. They will have a laminate posted at the station but ask if they have a different timing system if you do not see one. \n\nCheck that breading is sifted for every two bags of chicken or every 4 hours minimum. You may have to note during the audit how many bags of chicken they have gone through. One bag of raw chicken tenders fills one pan so keep an eye on how many pans of chicken they have gone through. Check that the pan of breading is minimum half full. \n\nCJR: Check that the chicken sifter is not used at the biscuit station (the sifter should be labeled chicken only). If you observe any sifter in use at the biscuit station that is labeled as \"chicken\' cite an opportunity.",
	criticality: "1",
    color: "#007AC9",
...
},
{
	...
	threshold: "Cite an opportunity if one or more occurrence is observed.",
	assessment: "Check that the correct number of chicken tenders are placed in the basket depending on basket size. Full size basket or regular sized basket are allowed for chicken tenders. See JOB AID for number allowed in each. \n\nChicken tenders are cooked for 3:15 and helf for a maximum of 30 minutes. Check that chicken tenders are shaked after 10 seconds in the fryer to seperate them. Check that chicken tenders are cooked for 3:15 by pressing the correct programmed button.",
	criticality: "2",
    color: "#EEAF00",
...
},
{
	...
	threshold: "Cite an opportunity if one or more occurrence is observed.",
	assessment: "MFS = Maid from Scratch.  MFS units have a biscuit station. These units will have a dual or tri-level warming unit with a  down heater. It is above the assembly line product items. The cooked chicken tenders MUST be held in the overshelf for these MFS stores. For non-MFS stores check that they are using an approved warming unit and only filling 9pcs per third size pan. \n\nPrince Castle warming units: the lid for those holding unit pans must be moved from the warming unit itself when used for chicken tender holding.",
	criticality: "1",
    color: "#007AC9",
...
},
{
	...
	threshold: "Cite an opportunity if one or more occurrence is observed.",
	assessment: "The Big Chicken fillet should be stored frozen and cooked for 4:30. Big Chicken may be held for 30 minutes max.\n\nHFS Comapny: At Hardee\'s comapny stores the Big Chicken may be held in the overshelf in a single layer with no overlapping. Hold time must still be monitored. If held in the Prince Castle unit the black lid must be removed.",
	criticality: "1",
    color: "#007AC9",
...
},
{
	...
	threshold: "Cite an opportunity if one or more occurrence is observed.",
	assessment: "Check that iced tea is within hold time of 8 hours max (an approved timing system must be in place; which may be a laminate, day dot, grease pen or plastic clock).\n\nIf iced tea is observed being made, check that it is prepared to standard:\n\n1. Two gallons should be made with 2 bags of tea and 192 oz. of cool dilution water (1.5 pitchers) for 1 brew cycle at 190 F. Three gallons should be made with 3 bags of tea and 320 oz. of cool diluition water (2.5 pitchers) for 1 brew cycle at 190 F min. No more than 3 bags may be brewed at one time!\n2. A clean paper coffee filter should be placed into the dedicated Tea filter cone.\n3. The appropriate number of tea bags should be poured into the paper filter.\n4. Funnel should be shaken slightly so tea is spread evenly in filter.\n5. A clean, empty stainless steel tea brew cup should be placed under the filter cone (not an airpot or 1/3 pan!)\n6. Start button is pressed and tea is brewed.\n7. After brew cycle has finished and tea no longer drips from the filter cone, the filter cone must be removed and discarded. TEA MUST NEVER BE REUSED FOR MORE THAN ONE BREW CYCLE!\n8. The concentrate tea is poured into a clean, sanitized Ice Tea Dispenser.\n9. Correct amount of cool (not ice cold) dilution water must be added to the dispenser as listed in step 1. \n10.  Repeat steps 2-7 until the needed amount of tea is prepared.\n\nNote: Some locations may use a Curtis Brewer that makes only 3 gallon batches at a time. They will add 3 bags of tea into the paper filter for this brewer and it will automatically brew and dilute the tea during a 10 minute brew time.\n\nSee JOB AID: 524 - ICED TEA for CJR and WC-089 Coffee and Iced Tea Procedures (08-13) for Hardee\'s) \n\nOld tea should never be mixed with freshly brewed tea as observed during audit. \n\nCJR: Check that prepared tea concentrate is stored under refrigeration in a covered container with a marked discard date of \"end of day\" or 24 hours max for locations open 24 hours a day.",
	criticality: "1",
    color: "#007AC9",
...
},
{
	...
	threshold: "Cite an opportunity if one or more occurrence is observed.",
	assessment: "Check that non-commerical coffee makers are not in use. Pour brew water from spigot into a coffee cup to check the brew water is 190-200 F. Check that coffee is not staged in filters. Check that brewed coffee is at a minimum of 160 F and a max of 180 F (only cite if below 160 F or above 200 F and coach only if it is between 180 F and 200 F). \n\nThe plastic spray head ensures water is sprayed evenly over the grounds and can be removed for cleaning. Ensure it is present if the brewer is in use. Check that coffee hold time is monitored using a timing system. \n\nNote: For CJR Regular coffee must be available all day long. Cite if regular coffee is not available. ",
	criticality: "1",
    color: "#007AC9",
...
},
{
	...
	threshold: "Cite an opportunity if one or more occurrence is observed.",
	assessment: "Check that pre-portioned cups are 8 oz. Zero out scale (digital or spring scale may be present) with an empty ice cream cup and then randomly select 4-5 pre-portioned cups to see that they are 7.8-8.2 oz (giving a +/- 0.2 oz) Check that ice cream cups are held frozen on the racks in the dipping cabinet and covered. A 12 hour hold time must be present (may be dated on tray or a laminate. Must use some timing system). \n\nNote: CJR Company stores will not stage with lids on each cup, they will cover with trays or plastic wrap. CJR Franchise: Staging with lids is approved. Hardee\'s: Lids or other covers both approved.",
	criticality: "1",
    color: "#007AC9",
...
},
{
	...
	threshold: "Cite an opportunity if one or more occurrence is observed.",
	assessment: "For Standard Shakes: 8 oz of vanilla ice cream should be used per shake (scooped or pre-portioned). Milk must be filled to line on cup. One pump of flavor syrup is added. Setting blender to #40 and blending thoroughly with up and down motion (no lumps of ice cream, nice and smooth). Shake dome lid should be placed on cup and whipped cream applied after dome lid is on. \n\nMalts: #40 food disher must be used to add 1 scoop of malt powder before adding the milk. For speciality shakes the correct portioning tool should be used for add-ins (Check applicable LTOs).",
	criticality: "1",
    color: "#007AC9",
...
},
{
	...
	threshold: "Cite an opportunity if one or more occurrence is observed.",
	assessment: "Monster Energy drinks (if present) must be held in their respective cooler. LTOs with Coke and lemondae type beverages may apply here as well. \n\nIf a store is using a small rotating ice cooler that sits on counter and holds Dasani water bottles and Minute Maid orange juice or another speciality coke LTO, the cooler must be rotated so the correct label is customer facing depending on what beverage is in the cooler ",
	criticality: "1",
    color: "#007AC9",
...
},
{
	...
	threshold: "Cite an opportunity if one or more occurrence is observed.",
	assessment: "Check that salads look fresh in appearance. Cite for salads that are excessively wilted or brown. If you are there while salads are being prepared check that they are being weighed/portioned to standard as follows:\n\nCJR Side salad:  3 oz of chopped iceberg lettuce into small plastic salad bowl (fill the bowl using a 32 oz measuring cup), and .25 oz spring mix (on top of iceberg)1 tomato wedge (placed at 6 o\'clock), .25 oz shredded cheese (using #60 scoop to place one scoop at 9 o\' clock), 1 slice cucumber (place at 12 o\'clock). Place lid on salad, add 12 hour discard time, and place under refrigeration.\n\nHFS Side Salad: Hardee\'s side salads are made to order. Fill black side salad bowl all the way with shredded lettuce. Evenly sprinkle a heaping #20 food disher of shredded cheddar cheese on top of the lettuce. Place 1 tomato slice on top of the cheese at 3 o\' clock. Place 2 red onion rings at the 9 o\' clock position overlapping slightly. Place lid on to-go salads only. Dine-in salads do not get a lid.\n \nCJR Chicken Salad: Use a 32 oz measuring cup to fill a LARGE plastic salad bowl compeltely to the rim with 6 oz of iceberg lettuce and 1 oz of spring mix covering the ice berg. Place two tomato wedges at 3 o\' clock, side by side. Use a 10\" clear plastic spoon to portion one spoon of shredded cheese at 6 o\'clock in bowl. Place 4 cucumber slices at 9 o\' clock in bowl slightly over-lapping each other. Place 3 red onion sliced rings at 12 o\' clock slightly over-lapping each other. Place lid on salad bowl and label bottom of bowl with 12 hour discard time. Place salad bowl under refrigeration. When the chicken salad is ordered by a customer, the lid is removed and a 3 oz perforated spoon is used to place one spoon (or one micro-tray boat) of heated GB (grilled) chicken or HB (crispy) chicken in the center of salad before placing lid back on bowl and serving.\n\nNOTE: CJR: They have chicken salads and side salads. Hardee\'s: Only side salads at some locations.  The pre-portioned single use salad containers must be tagged (12 hours) and never dated multiple times (look for stickers placed over older stickers or sticker residue from removed stickers). \n\nCheck that correct condiments and dressings are provided for each salad (1 packet of croutons, 1 packet of salad dressing, and 1 fork). Customer always chooses the dressing.",
	criticality: "1",
    color: "#007AC9",
...
},
{
	...
	threshold: "Cite an opportunity if one or more occurrence is observed.",
	assessment: "All desserts should be tagged with a hold time and not held past code/exp date. Chocolate cake and cookies are held room temperature. Strawberry cheesecake is held under refrigeration. Check LTO dessert standards. \n\nHardee\'s: No chocolate cake or cheesecake, only cookies. If cookies are baked on site check that they are prepared and packaged to standard (see JOB AID)",
	criticality: "1",
    color: "#007AC9",
